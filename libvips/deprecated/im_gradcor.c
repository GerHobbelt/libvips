...
#undef small  // MSVC
int
im_gradcor_raw(IMAGE *large, IMAGE *small, IMAGE *out)
{
...
static void *
gradcor_start(IMAGE *out, void *vptr_large, void *unrequired)
{
...
static int
gradcor_stop(void *vptr_seq, void *unrequired, void *unreq2)
{
...
static int
gradcor_gen(REGION *to_make, void *vptr_seq, void *unrequired, void *vptr_grads)
{
